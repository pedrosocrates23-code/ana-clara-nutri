---
title: "Quando procurar um nutricionista: os sinais de que chegou a hora"
metaTitle: "Quando Procurar um Nutricionista: os sinais"
description: "Você pode procurar um nutricionista sempre que a alimentação vira fonte de dúvida, desconforto ou frustração. Não é preciso estar doente nem ter encaminhamento."
h1: "Quando procurar um nutricionista: os sinais de que chegou a hora"
path: "/blog/quando-procurar-um-nutricionista"
silo: "blog"
siloLabel: "Blog"
datePublished: "2026-07-23"
medical: false
image: "/blog/quando-procurar-um-nutricionista.webp"
imageAlt: "Mulher pensativa com um café, junto à janela com luz da manhã"
faqs:
  - q: "Quando é a hora certa de procurar um nutricionista?"
    a: "A hora costuma ser quando a alimentação vira fonte de dúvida, desconforto ou frustração, e não só quando você quer emagrecer. Um exame alterado, cansaço, desconforto intestinal, uma relação difícil com a comida ou o cansaço de dietas que não duram já são motivos suficientes. Você não precisa esperar um problema grande para começar a cuidar."
  - q: "Preciso de encaminhamento médico para ir ao nutricionista?"
    a: "Não. No atendimento particular, o acesso é direto: você agenda sem depender de pedido ou encaminhamento do médico. Se você já tem exames ou faz acompanhamento com um médico, leve essas informações para a consulta, porque elas ajudam na avaliação. Nada disso, porém, é pré-requisito para começar."
  - q: "Preciso estar doente para procurar um nutricionista?"
    a: "Não. A profissão é regulamentada pela Lei nº 8.234/1991, que inclui o cuidado nutricional de pessoas sadias, e não só de quem já tem uma doença. Procurar um nutricionista pode ser um cuidado preventivo: muitas vezes é mais simples cuidar da alimentação antes de um quadro se instalar do que depois."
  - q: "O atendimento online com nutricionista funciona?"
    a: "A telenutrição é regulamentada pela Resolução CFN nº 760/2023 e exige inscrição ativa no CRN e cadastro na plataforma e-Nutricionista. A avaliação, a construção do plano e os retornos acontecem por videochamada. Ana Clara Andrade Santos, nutricionista CRN-1 nº 19825, atende adultos por telenutrição em todo o Brasil e presencialmente em Goiânia."
references:
  - label: "Lei nº 8.234/1991"
    detail: "Regulamenta a profissão de nutricionista e descreve a assistência nutricional a pessoas sadias ou enfermas, reconhecendo o cuidado também na prevenção."
    url: "https://www.planalto.gov.br/ccivil_03/leis/1989_1994/l8234.htm"
  - label: "Resolução CFN nº 306/2003"
    detail: "Conselho Federal de Nutricionistas. Permite que o próprio nutricionista solicite exames quando necessários para a avaliação nutricional."
    url: "https://cfn.org.br/wp-content/uploads/resolucoes/Res_306_2003.htm"
  - label: "Resolução CFN nº 760/2023"
    detail: "Conselho Federal de Nutricionistas. Regulamenta a telenutrição e exige inscrição ativa no CRN e cadastro na plataforma e-Nutricionista."
...
A profissão de nutricionista é regulamentada pela [Lei nº 8.234/1991](https://www.planalto.gov.br/ccivil_03/leis/1989_1994/l8234.htm), que descreve a assistência nutricional a pessoas sadias ou enfermas. Sadias, repare, aparece primeiro.
...
Quando um exame vem alterado, ajustar a alimentação desde já é justamente o que ajuda a evitar que o quadro avance. O médico segue cuidando do lado clínico, e o cuidado com a comida caminha ao lado dele, na fronteira da [nutrição clínica](/nutricao-clinica/).
...
Quando o desconforto digestivo passa de eventual a rotina, ele deixa de ser azar do dia e vira um sinal que vale escutar. O bem-estar digestivo, a forma como o intestino responde ao que você come, é uma frente inteira de cuidado dentro da [saúde intestinal](/saude-intestinal/).
...
É sobre alinhar o que você come ao esforço que você faz, à sua rotina e ao seu ritmo. A alimentação alinhada ao treino, na frente da [nutrição esportiva](/nutricao-esportiva/), é um ajuste fino que parte da sua realidade, não uma tabela genérica tirada da internet.
...
A [Resolução CFN nº 306/2003](https://cfn.org.br/wp-content/uploads/resolucoes/Res_306_2003.htm) permite que o próprio nutricionista solicite exames quando forem necessários para essa avaliação. Ninguém está ali para apontar erros.
...
O atendimento por telenutrição, a consulta feita por videochamada, é uma modalidade regulamentada, não um improviso. A [Resolução CFN nº 760/2023](https://cfn.org.br/cfn-publica-resolucao-que-regulamenta-a-telenutricao/) regulamenta a telenutrição e exige inscrição ativa no CRN e cadastro na plataforma e-Nutricionista, além do respeito ao sigilo e à proteção dos seus dados.

A avaliação, a construção do plano e os retornos acontecem por vídeo, com a mesma seriedade do presencial. Se os sinais deste texto são seus e você está em outra cidade, o [atendimento online](/nutricionista-online) alcança você onde estiver.

## Atendimento em Goiânia e por telenutrição

O acompanhamento acontece presencialmente em Goiânia e por [telenutrição para todo o Brasil](/nutricionista-online). A telenutrição é regulamentada pela Resolução CFN nº 760/2023, e a profissional precisa estar cadastrada no cadastro e-Nutricionista do CFN, o cadastro nacional para teleconsulta.
