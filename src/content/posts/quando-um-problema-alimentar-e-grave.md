---
title: "Quando um problema alimentar é grave: sinais que pedem avaliação"
metaTitle: "Quando um Problema Alimentar é Grave e Pede Ajuda"
description: "Um problema alimentar tende a ser grave quando se repete por semanas, causa sofrimento e prejudica a rotina. Sinais que pedem avaliação profissional."
h1: "Quando um problema alimentar é grave: sinais que pedem avaliação"
path: "/nutricao-comportamental/quando-um-problema-alimentar-e-grave"
silo: "nutricao-comportamental"
siloLabel: "Nutrição Comportamental"
datePublished: "2026-07-23"
medical: true
image: "/blog/quando-um-problema-alimentar-e-grave.webp"
imageAlt: "Mãos segurando uma xícara de chá, num momento de acolhimento"
faqs:
  - q: "Como sei se meu problema com a comida é grave?"
    a: "Não existe um número mágico de sinais que \"prove\" gravidade, e tentar se encaixar numa lista sozinha não ajuda. O que costuma indicar que vale procurar avaliação é o conjunto, quando o comportamento se repete por semanas, causa sofrimento intenso e passa a prejudicar sua rotina, seu humor e sua saúde."
  - q: "Isso é frescura ou é coisa séria?"
    a: "Sofrimento com a comida nunca é frescura. A dificuldade com a alimentação costuma ter causas emocionais, comportamentais e fisiológicas, e não é uma questão de força de vontade ou de caráter. Se a comida ocupa um espaço grande e doloroso na sua vida, isso já é motivo legítimo para buscar cuidado."
  - q: "O nutricionista trata transtorno alimentar?"
    a: "O diagnóstico de um transtorno alimentar é feito pelo médico, e a psicoterapia é conduzida pelo psicólogo. A nutricionista cuida da sua relação com a comida e do comportamento alimentar, e integra a equipe pela porta da alimentação. O cuidado costuma ser de mais de um profissional, cada um no seu papel, e nenhum trata o quadro sozinho."
  - q: "Por qual profissional eu começo?"
    a: "Não existe uma porta obrigatória. Você pode começar pelo médico, pelo psicólogo ou pela nutricionista, e o importante é começar. Muitas vezes o profissional que você procurar primeiro ajuda a montar a rede de cuidado com os outros."
  - q: "Dá para cuidar disso por telenutrição, mesmo morando longe?"
    a: "Sim, no que diz respeito à parte alimentar. A telenutrição é reconhecida pelo Conselho Federal de Nutricionistas, pela Resolução CFN nº 760/2023, e permite acompanhamento à distância com a mesma seriedade da consulta presencial. Ana Clara atende presencialmente em Goiânia e por telenutrição para todo o Brasil, e pode fazer parte de um cuidado que envolve também médico e psicólogo."
references:
  - label: "Lei nº 8.234/1991"
    detail: "Regulamenta a profissão de nutricionista. A assistência e a educação nutricional integram o escopo privativo da profissão."
    url: "https://www.planalto.gov.br/ccivil_03/leis/1989_1994/l8234.htm"
  - label: "Lei nº 12.842/2013 (Ato Médico)"
    detail: "Define os atos privativos do médico. O diagnóstico e a prescrição de medicamento são atos médicos."
    url: "https://www.planalto.gov.br/ccivil_03/_ato2011-2014/2013/lei/l12842.htm"
  - label: "Resolução CFN nº 760/2023"
    detail: "Conselho Federal de Nutricionistas. Regulamenta a telenutrição e exige inscrição ativa no CRN, cadastro na plataforma e-Nutricionista e termo de consentimento antes do primeiro atendimento."
    url: "https://cfn.org.br/cfn-publica-resolucao-que-regulamenta-a-telenutricao/"
  - label: "CVV, Centro de Valorização da Vida"
    detail: "Apoio emocional gratuito e sigiloso pelo telefone 188, 24 horas por dia, em todo o Brasil."
    url: "https://cvv.org.br/ligue-188/"
  - label: "CAPS, Rede de Atenção Psicossocial (RAPS) do SUS"
    detail: "Ministério da Saúde. Atendimento aberto e comunitário em saúde mental pela rede pública."
    url: "https://www.gov.br/saude/pt-br/composicao/saes/desme/raps"
  - label: "AMBULIM, Programa de Transtornos Alimentares"
    detail: "Instituto de Psiquiatria do Hospital das Clínicas da Faculdade de Medicina da USP. Serviço de referência que atua com psiquiatra, psicólogo e nutricionista na mesma equipe."
---
...
Vale diferenciar dois momentos. Há o incômodo do dia a dia, quando a alimentação te desagrada e você quer ajuda para reorganizar, e para isso ajuda [saber quando procurar um nutricionista no dia a dia](/blog/quando-procurar-um-nutricionista).
...
Quem fecha o diagnóstico de um transtorno alimentar é o médico, em geral o psiquiatra. Diagnosticar e, quando for o caso, prescrever medicamento são atos médicos, previstos na [Lei 12.842/2013](https://www.planalto.gov.br/ccivil_03/_ato2011-2014/2013/lei/l12842.htm).
...
Quando a comida está muito ligada à ansiedade, vale entender a diferença entre [procurar psicólogo ou nutricionista quando se come por ansiedade](/nutricao-comportamental/psicologo-ou-nutricionista-ansiedade).

### A nutricionista e a relação com a comida

A nutricionista cuida da relação com a comida e do comportamento alimentar. A assistência e a educação nutricional fazem parte do escopo da profissão, definido na [Lei 8.234/1991](https://www.planalto.gov.br/ccivil_03/leis/1989_1994/l8234.htm).

Na prática, é reconstruir uma forma de comer que não seja uma guerra, sem lista de proibições. Uma [nutrição com abordagem comportamental](/nutricao-comportamental) entra pela porta da alimentação, dentro da equipe, não no lugar dela.

Existe, inclusive, um caminho para [como parar a compulsão sem se prender a mais uma dieta](/nutricao-comportamental/compulsao-alimentar-como-parar).
...
Alguns canais gratuitos existem justamente para os momentos difíceis, e listá-los aqui é dever de cuidado, não indicação comercial. Em momentos de sofrimento psíquico intenso, o [CVV oferece apoio emocional gratuito e sigiloso pelo telefone 188](https://cvv.org.br/ligue-188/), 24 horas por dia, em todo o Brasil.

Para acompanhamento em saúde mental pela rede pública, os [CAPS, dentro da Rede de Atenção Psicossocial do SUS](https://www.gov.br/saude/pt-br/composicao/saes/desme/raps), oferecem atendimento aberto e comunitário. Nenhum deles é pago, e nenhum substitui o outro.

## Atendimento em Goiânia e por telenutrição para todo o Brasil

O acompanhamento acontece presencialmente em Goiânia, no beLIV Espaço de Saúde e Bem-Estar, e por [telenutrição para todo o Brasil](/nutricionista-online).
...
Você não precisa ter todas as respostas antes de começar, nem esperar ter certeza do que é. Quando se sentir pronta, [agende sua consulta](/contato) sem pressa e sem a obrigação de dar conta de tudo de uma vez. Um passo por vez já é progresso, e o primeiro passo não é uma decisão de vida, é uma conversa.
