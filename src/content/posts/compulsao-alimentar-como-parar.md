---
title: "Compulsão alimentar: como parar sem se prender a mais uma dieta"
metaTitle: "Compulsão alimentar: como parar sem mais uma dieta"
description: "Compulsão alimentar raramente é falta de força de vontade: costuma ser a resposta do corpo à restrição, e o ciclo se desarma."
h1: "Compulsão alimentar: como parar sem se prender a mais uma dieta"
...
faqs:
  ...
  - q: "Comer demais de vez em quando já é compulsão?"
    a: "Não necessariamente. Um dia de exagero numa festa, ou comer por prazer, é diferente de um episódio de compulsão alimentar, cujo marcador é a sensação de perda de controle, quase sempre com culpa depois. Se isso vira um padrão que se repete e traz sofrimento, vale procurar um profissional para avaliar."
  - q: "Preciso cortar açúcar e carboidrato para parar com a compulsão?"
    a: "Cortar grupos de alimentos e criar proibições tende a piorar, porque a restrição é um dos maiores disparadores do descontrole. O caminho costuma ser o contrário: comer de forma regular e tirar os alimentos do lugar de proibido. Um nutricionista ajuda a fazer isso de forma individualizada, sem regras que você vai furar e depois se culpar."
  - q: "O que eu faço na hora exata em que bate a vontade?"
    a: "Antes de brigar com a vontade, faça uma pausa curta e pergunte se aquilo é fome física, que vem devagar e aceita qualquer comida, ou se é uma emoção pedindo colo. Se for fome, coma sentada e devagar, sem tela. Se for emoção, nomear o que você sente já muda o tamanho da vontade."
  - q: "Como saber se a minha compulsão alimentar é um transtorno?"
    a: "Quem responde isso é um profissional, nunca um artigo e nunca você sozinha. A literatura clínica considera a frequência e o sofrimento: episódios que se repetem ao longo de meses, com angústia intensa e impacto na rotina, pedem avaliação. Você não precisa de certeza nem de um quadro grave para procurar ajuda."
  - q: "Compulsão alimentar tem cura?"
    a: "Não existe fórmula mágica nem prazo garantido, e desconfie de quem promete. O que a literatura clínica descreve é a possibilidade de reduzir os episódios e reconstruir uma relação mais tranquila com a comida, no seu tempo. Cada história é única, e o objetivo do cuidado é a sua autonomia, não a sua adesão a mais uma regra."
  - q: "Se eu tiver uma recaída, voltei à estaca zero?"
    a: "Não. A recaída faz parte do processo de recuperação e não apaga o que você já construiu. O que costuma fazer estrago não é o episódio em si, e sim a reação depois dele: se punir e apertar a restrição, que é exatamente o que prepara o próximo. Um episódio é informação sobre um disparador."
  - q: "Preciso de nutricionista ou de psicólogo para compulsão alimentar?"
    a: "Na maior parte das vezes, dos dois. A compulsão alimentar tem uma camada emocional e uma camada de relação com a comida, e o cuidado mais completo trabalha as duas ao mesmo tempo, com avaliação médica quando indicado. O psicólogo cuida dos padrões emocionais, e o nutricionista, da regularidade e da relação com a comida."
references:
  ...
  - label: "DSM-5, Manual Diagnóstico e Estatístico de Transtornos Mentais"
    detail: "Critérios do Transtorno da Compulsão Alimentar Periódica: janela de até duas horas, ao menos três de cinco características e frequência média de um episódio por semana nos últimos três meses."
  - label: "SPDM, Associação Paulista para o Desenvolvimento da Medicina"
    detail: "Descreve o transtorno da compulsão alimentar como distúrbio neurobiológico e psicológico reconhecido, que exige avaliação e tratamento profissional, e aponta maior prevalência em famílias com histórico de transtornos alimentares."
  - label: "Estudo com 133 estudantes de nutrição sobre dieta restritiva e compulsão alimentar"
    detail: "Revista JRG de Estudos Acadêmicos. Encontrou associação entre seguir dieta restritiva e apresentar episódios de compulsão alimentar."
  - label: "Pesquisa da Universidade de São Paulo sobre mindful eating"
    detail: "Associa práticas de comer com atenção plena a melhora do comportamento alimentar e a redução de episódios de compulsão, de estresse e de ansiedade."
  - label: "MD.Saúde, transtorno da compulsão alimentar periódica"
    detail: "Prevalência estimada em torno de 3% da população, sendo cerca de dois terços mulheres, e distinção em relação à bulimia nervosa pela ausência de comportamento compensatório."
---
...
Se o que te trouxe até aqui, no fundo, é o peso, eu entendo. Esse assunto tem um caminho próprio, que passa por [emagrecer sem dieta restritiva, no seu tempo](/emagrecimento/), e não por apertar mais o controle.
...
- **Tirar os alimentos do lugar de proibido.** É a permissão consciente: o pão que está liberado perde o poder que tinha quando era pecado. Desarma a última ceia e o "já que eu comi um, comi tudo". A [educação alimentar](/educacao-alimentar/) trabalha exatamente essa autonomia, sem lista de proibições.
...
Se você não mora em Goiânia, isso não te exclui. A [telenutrição para todo o Brasil](/nutricionista-online/) é regulamentada pela Resolução CFN nº 760/2023, a norma do Conselho Federal de Nutricionistas para atendimento a distância, que exige inscrição ativa no CRN, cadastro prévio na plataforma e-Nutricionista e um termo de consentimento antes do primeiro atendimento.

Se você mora aqui, existe o [atendimento presencial em Goiânia](/nutricionista-em-goiania/), no beLIV Espaço de Saúde e Bem-Estar. Nos dois casos, o atendimento é exclusivamente particular. Eu prefiro te dizer isso agora, com todas as letras, a te deixar descobrir depois.
