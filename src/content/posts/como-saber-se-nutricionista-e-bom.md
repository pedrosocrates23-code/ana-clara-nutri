---
title: "Como saber se um nutricionista é bom antes da primeira consulta"
metaTitle: "Como saber se um nutricionista é bom: o que checar antes"
description: "Como saber se um nutricionista é bom antes de marcar: registro ativo no CRN, abordagem declarada, escopo claro e ausência de promessa de resultado."
h1: "Como saber se um nutricionista é bom antes da primeira consulta"
...
faqs:
  ...
  - q: "Quanto tempo dura o acompanhamento com nutricionista?"
    a: "Não existe regra fixa, porque a duração acompanha os seus objetivos e o seu processo. A cadência dos retornos também se combina caso a caso. O sinal de qualidade não está na frequência prometida, e sim no retorno estar previsto desde o começo, porque isso mostra que o trabalho é um processo."
  - q: "Como eu sei se o nutricionista atende o meu caso?"
    a: "Pergunte diretamente, e valorize quem responde com clareza sobre o que atende e o que não atende. Quem diz 'atendo tudo' dá uma resposta mais frágil do que parece. Ana Clara Andrade Santos, por exemplo, atende adultos em Goiânia e por telenutrição, em modelo exclusivamente particular, e não atende gestantes nem crianças."
  - q: "Vale a pena trocar de nutricionista se eu não me adaptei ao primeiro?"
    a: "Vale, e não ter se adaptado não é fracasso seu. Antes de trocar, tente identificar o que não encaixou: a abordagem, o formato do atendimento ou a comunicação. Saber qual das três te incomodou é o que faz a próxima escolha ser melhor do que a anterior, em vez de virar mais uma tentativa."
references:
  - label: "Resolução CFN nº 856, de 25 de abril de 2026 (Código de Ética e Conduta da(o) Nutricionista)"
    detail: "Vedações de promessa de resultado, de divulgação de resultado por imagem ou exame, de oferta e sorteio e de titulação não possuída. Artigos consultados em análise comentada publicada pela Nutrição Comportamental em 16/07/2026."
    url: "https://nutricaocomportamental.com.br/codigo-de-etica-nutricionistas-2026/"
  - label: "Conselho Regional de Nutricionistas da 1ª Região (CRN-1), consulta de cadastro de profissionais"
    detail: "Campos de busca, dados retornados, significado da situação inativa e abrangência do CRN-1 (DF, GO, MT e TO). Consultada em 16/07/2026."
    url: "https://novoportal.crn1.org.br/servicos-online-outros/"
  - label: "e-Nutricionista, Cadastro Nacional de Nutricionistas para Teleconsulta"
    detail: "Conselho Federal de Nutricionistas. Consulta pública de quem pode atender por telenutrição. Consultado em 16/07/2026."
    url: "https://enutricionista.cfn.org.br/"
  - label: "DECO Proteste, \"Consulta de nutrição ou plano de emagrecimento? Pergunte antes de marcar\""
    detail: "Organização de defesa do consumidor. Perguntas antes de marcar, compra obrigatória de suplemento e ausência de individualização. Consultado em 16/07/2026."
    url: "https://www.deco.proteste.pt/alimentacao/dietas-emagrecimento/noticias/consulta-nutricao-plano-emagrecimento-pergunte-antes-marcar"
  - label: "Maldita.es, \"¿Qué red flags delatan a un mal experto en nutrición?\", 28/04/2026"
    detail: "Checagem de fatos. Linguagem pseudocientífica, promessa de perda de peso em prazo determinado e verificação de credenciais."
    url: "https://maldita.es/prebunking/20260525/que-red-flags-delatan-a-un-mal-experto-en-nutricion/"
  - label: "Reclame Aqui, reclamação de paciente que não recebeu o plano alimentar após a consulta"
    detail: "Registro público, usado no texto apenas como exceção documentada. Consultado em 16/07/2026."
    url: "https://www.reclameaqui.com.br/nav-dasa/nutricionista-nao-enviou-receita-apos-consulta_RfMPR0aSwHlTo67a/"
---
...
O meu trabalho, para servir de exemplo, usa [abordagem comportamental e educacional](/nutricao-comportamental/), o que significa, na prática, escutar antes de orientar. A conduta, que é o plano montado para a sua vida, vem depois da escuta, nunca antes.
...
A resposta te diz muito. E, sendo honesta, ela também explica por que tanta gente abandona: um molde que serve para todo mundo dificilmente cabe na sua semana. Aprender a fazer as próprias escolhas é o objetivo do processo, e disso trata a [educação alimentar](/educacao-alimentar/).
