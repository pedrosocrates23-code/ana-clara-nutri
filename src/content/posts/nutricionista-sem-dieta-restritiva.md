---
title: "Nutricionista que não passa dieta restritiva: como é o acompanhamento"
metaTitle: "Nutricionista sem Dieta Restritiva: como é a consulta"
description: "Nutricionista que não passa dieta restritiva troca o cardápio proibitivo pelo trabalho com o comportamento alimentar. Como é a consulta."
h1: "Nutricionista que não passa dieta restritiva: como é o acompanhamento"
...
faqs:
  ...
  - q: "Se não tem cardápio para seguir, como eu vou saber o que comer?"
    a: "Não passar dieta restritiva não significa ficar sem orientação. A orientação existe e é individualizada, só que construída junto com você, a partir da sua rotina, em vez de entregue pronta a partir de uma tabela. No lugar de uma lista para decorar, o acompanhamento constrói o seu critério de escolha, que é o que continua funcionando depois que a consulta termina."
  - q: "Isso quer dizer que eu vou poder comer de tudo?"
    a: "Significa que nenhum alimento é tratado como vilão e que você não vai receber uma lista de proibidos. Não significa ausência de método: o trabalho é entender como, quando e por que você come, e isso costuma mudar as suas escolhas mais do que uma proibição mudaria. Comer com flexibilidade é uma habilidade que se constrói, não é abandonar o cuidado."
  - q: "E se eu recair ou desistir no meio, como já aconteceu antes?"
    a: "A recaída não é tratada como fracasso nem como motivo de culpa: ela é informação sobre o seu comportamento e é parte esperada de qualquer processo. O acolhimento vem antes da cobrança, e desistir no meio não fecha a porta. Se você sumir e quiser voltar depois, você volta, e a conversa recomeça de onde você estiver."
  - q: "Nunca fui a uma nutricionista porque tenho medo de ser julgada. Como é a primeira consulta?"
    a: "A primeira consulta é uma escuta: a conversa começa pela sua história, pela sua rotina e pelos seus desafios, antes de qualquer orientação. Ninguém é julgado pelo que come nem pelo ponto em que está. Consultas nutricionais costumam durar em torno de 45 a 60 minutos, e é comum levar exames recentes e a relação de medicamentos e suplementos em uso, se você tiver."
  - q: "Ana Clara atende quem mora fora de Goiânia?"
    a: "Sim. Além do atendimento presencial em Goiânia, Ana Clara atende por telenutrição para todo o Brasil, modalidade regulamentada pela Resolução CFN nº 760/2023. Profissionais que atendem online precisam estar cadastradas no e-Nutricionista, o cadastro nacional do CFN para teleconsulta, e qualquer pessoa pode consultar esse cadastro para verificar. O modelo de acompanhamento é o mesmo no online."
  - q: "O atendimento é particular ou por convênio?"
    a: "O atendimento é exclusivamente particular. Não há atendimento por convênio, e isso é dito com transparência para que você saiba exatamente o que esperar antes de agendar."
references:
  - label: "Resolução CFN nº 856/2026, Código de Ética e Conduta do Nutricionista"
    detail: "Conselho Federal de Nutricionistas, abril de 2026. Veda a promessa de resultado e a divulgação de imagens de antes e depois, de composição corporal e de gráficos de evolução, mesmo com autorização do cliente."
    url: "https://www.legisweb.com.br/legislacao/?id=494878"
  - label: "Resolução CFN nº 760/2023"
    detail: "Conselho Federal de Nutricionistas. Regulamenta a telenutrição e exige inscrição ativa no CRN, cadastro prévio na plataforma e-Nutricionista e termo de consentimento antes do primeiro atendimento."
    url: "https://cfn.org.br/cfn-publica-resolucao-que-regulamenta-a-telenutricao/"
  - label: "Sumithran P. et al. Long-Term Persistence of Hormonal Adaptations to Weight Loss"
    detail: "New England Journal of Medicine, 2011;365(17):1597-1604. 50 participantes, perda média de 13,5 kg em 10 semanas; grelina elevada, leptina reduzida e fome relatada acima do valor inicial ainda às 62 semanas."
  - label: "Hinte L.C. et al. Adipose tissue retains an epigenetic memory of obesity after weight loss"
    detail: "Nature, 2024. O tecido adiposo retém alterações transcricionais e epigenéticas induzidas pela obesidade mesmo após perda de peso substancial."
...
A coluna da direita tem um custo, e eu volto nele mais adiante: ela é mais lenta no começo. Se o seu objetivo específico for emagrecer, esse assunto tem casa própria aqui no site e passa por [reeducação alimentar sem proibição](/emagrecimento/), não por corte.
...
1. **A conversa começa por você**, não pelo peso. Rotina, trabalho, casa, história com comida e com dieta.
2. **A avaliação profissional entra**, com o histórico de saúde, os exames que você tiver em mãos e o que usa de medicamento ou suplemento.
3. **Os padrões aparecem**: em que horários, em que situações e depois de quais dias o comer sai do lugar que você gostaria.
4. **A orientação é construída junto**, a partir do que a sua semana real comporta, e não do que uma semana ideal comportaria.
5. **O retorno reavalia** o que funcionou e o que não funcionou, e ajusta.
...
É essa a razão de [educação alimentar](/educacao-alimentar/) e cardápio não serem a mesma coisa. Um cardápio te diz o que fazer hoje. Educação alimentar te deixa capaz de decidir amanhã, quando eu não estiver por perto.
...
Meus mais de 4 anos de experiência em [nutrição clínica](/nutricao-clinica/), em hospital e em ambulatório, são justamente o que me permite reconhecer quando um caso pede controle mais cuidadoso de alguma coisa e quando pede trabalho de comportamento.
...
O acompanhamento acontece presencialmente em Goiânia, no beLIV Espaço de Saúde e Bem-Estar, na Av. dos Ipês, Chácara 22, CEP 74855-390, e por [telenutrição para todo o Brasil](/nutricionista-online).

A telenutrição tem regra, e a regra é a seu favor. Ela é regulamentada pela Resolução CFN nº 760/2023, e a profissional precisa estar cadastrada no [cadastro e-Nutricionista do CFN](https://enutricionista.cfn.org.br), o cadastro nacional para teleconsulta. Qualquer pessoa pode consultar esse cadastro e verificar se quem vai atender está regular. Existe também um termo de consentimento antes do primeiro atendimento, e a consulta não pode ser gravada nem compartilhada por nenhuma das partes.
