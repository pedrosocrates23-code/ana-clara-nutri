---
title: "Por que você não consegue seguir a dieta e não é força de vontade"
metaTitle: "Por que eu não consigo seguir a dieta: o mecanismo real"
description: "Por que você não consegue seguir a dieta tem explicação fisiológica e comportamental, com grelina, leptina e adaptação metabólica medidas em estudo."
h1: "Por que você não consegue seguir a dieta e não é força de vontade"
path: "/nutricao-comportamental/por-que-nao-consigo-seguir-a-dieta"
...
faqs:
  ...
  - q: "Então não é falta de força de vontade?"
    a: "A força de vontade existe, mas é finita: ela se desgasta ao longo do dia e sofre com sono ruim, estresse e fome acumulada. Depender só dela para resistir à comida à noite, cansada, é apostar contra a própria biologia. O método restritivo falha também em pessoas comprovadamente disciplinadas, o que indica que a variável explicativa é outra."
  - q: "É normal desistir da dieta tantas vezes?"
...
references:
  ...
  - label: "Fothergill E. et al. Persistent metabolic adaptation 6 years after 'The Biggest Loser' competition"
    detail: "Obesity, 2016. 14 dos 16 participantes; perda de 58,3 kg em 30 semanas e queda de 610 kcal por dia na taxa metabólica de repouso, que seguia 704 kcal por dia abaixo do valor inicial seis anos depois."
  - label: "Westenhoefer J., Stunkard A.J., Pudel V. Validation of the flexible and rigid control dimensions of dietary restraint"
    detail: "International Journal of Eating Disorders, 1999;26(1):53-64. 54.517 participantes no primeiro estudo; controle rígido associado a mais desinibição e compulsão, controle flexível associado a menos episódios e melhor manutenção."
  - label: "Keys A. et al. Minnesota Starvation Experiment"
    detail: "1944-1945. 36 homens jovens e saudáveis submetidos a restrição severa por 13 meses; obsessão por comida durante a restrição e perda de controle na reintrodução alimentar."
  - label: "Herman C.P. e Mack D., estudo de preload; efeito nomeado por Herman C.P. e Polivy J. como 'what the hell effect'"
    detail: "Quem estava de dieta comeu mais depois do milk-shake, e quem não estava comeu menos: a regra quebrada, e não a comida ingerida, determinou o comportamento."
---
...
Se o método falha por design, a resposta lógica muda de categoria. Procurar a dieta certa mantém você dentro da categoria que falhou. O que muda de lugar é o objeto de trabalho: sai o cardápio, entra o comportamento, e essa é a proposta da [abordagem comportamental e educacional](/nutricao-comportamental).
...
O nome disso quando dá certo é **autonomia alimentar**: você escolhendo sozinha, sem depender de um plano rígido nem de uma nutricionista para sempre. A [reeducação alimentar sem dieta restritiva](/emagrecimento) trabalha nessa direção, desde que ela não seja apenas dieta com nome mais bonito.
...
Se um dia você quiser trocar a regra externa por [autonomia nas escolhas alimentares](/educacao-alimentar), esse caminho existe e não passa por mais uma dieta.
